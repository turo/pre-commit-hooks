...
This folder contains exact replications of the licenses from open source
software that was used as a direct reference or in whole or in part to create
this derivative work.

## License sources

The following projects' licenses are linked in their current form here.
